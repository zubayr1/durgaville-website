...
import Durgapujo2026 from "./Durgapujo2026";

function DashboardDurgapujo2026() {
  ...
  return (
    <div style={{ overflow: "hidden" }}>
      <Helmet>
        <title>Pujo, 2026 - Durgaville</title>
        <meta name="description" content="Welcome to Sharod Utsav, 2026, organized by Durgaville" />
      </Helmet>
...
export default DashboardDurgapujo2026;
