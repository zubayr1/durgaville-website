...
function AdminLogin() {
    ...
    if(message!=="")
    {
        layout = <div>
            <Message
                error
                header='Authentication failed due to one of these reasons:'
                list={[
                'Access denied',
            ...
            <Grid.Row>
                <Grid.Column textAlign='center' width={16}>
                    <Form onSubmit={handleSubmit} style={{ width: '100%' }}>
                        ...
                        <Button type='submit' style={{ backgroundColor: 'white', color: 'black', border: '2px solid black', fontSize:'1.3rem' }}>Sign In</Button>
                    </Form>
                </Grid.Column>
            </Grid.Row>
