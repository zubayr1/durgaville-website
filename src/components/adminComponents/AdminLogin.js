        ...
        <Grid.Row>
          <Grid.Column textAlign="center" width={16}>
            <Form onSubmit={handleSubmit} style={{ width: "100%" }}>
              ...
              <FormField>
                <label htmlFor="admin email" style={{ fontWeight: "bold", fontFamily: "Inter", fontSize: "1.3rem" }}>
                  Admin Email
                </label>
                <input placeholder="Email Id" value={email} onChange={(e) => setEmail(e.target.value)} />
              </FormField>
              <FormField>
                <label htmlFor="admin password" style={{ fontWeight: "bold", fontFamily: "Inter", fontSize: "1.3rem" }}>
                  Admin Password
                </label>
