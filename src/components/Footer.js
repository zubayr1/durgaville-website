  ...
  else if(error===2)
  {
    layout=<div> 
        <Message
            error
            header='Sorry!'
            content='Error due to unforeseen issue'
        />
    </div>
  }
  else if(error===0)
              ...
              <Grid>
                <Grid.Row>
                  <Form onSubmit={handleSubmit} style={{ width: '100%' }}>
                      <FormField>
                          <label style={{fontWeight:'bold', fontFamily: 'Inter', fontSize:'1.3rem', color:'#606166', marginBottom: '2%'}}>
                            Name</label>
                          <input 
                                  placeholder=''
                                  value={name}
              ...
              <Grid.Row width={7} verticalAlign='middle'>
                <Grid centered style={{ marginBottom: '50px' }}>
                  <Grid.Row width={4} style={{ padding: 0 }}>
                    <p style={{ fontWeight: 'bold', fontFamily: 'Inter', fontSize: '1.1rem', color: '#606166', marginBottom: '2%' }}>
                      ADDRESS</p>
                  </Grid.Row>
