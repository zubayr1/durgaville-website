    ...
    >
      <Grid centered>
        <Grid.Row only="computer">
          <Grid.Column floated="left" width={8} style={{ paddingLeft: '5%', paddingRight: '5%', borderRight: '1px solid #a1a1ab' }}>
            <Grid>
              <Grid.Row>
          ...
          <Grid.Column width={6} verticalAlign="middle">
            <Grid centered style={{ marginBottom: '50px' }}>
              ...
              <Grid.Column floated="left" width={8} style={{ padding: 0 }}>
                <p style={{ fontFamily: 'Inter', fontSize: '1.4rem', color: '#919199', margin: 0 }}>Am Europakanal 2, 91056</p>
                <p style={{ fontFamily: 'Inter', fontSize: '1.4rem', color: '#919199', margin: 0 }}>Erlangen, Germany</p>
              </Grid.Column>
            </Grid>
            ...
            <Grid centered style={{ marginTop: '50px' }}>
              ...
              <Grid.Column floated="left" width={8} style={{ padding: 0 }}>
                <p style={{ fontFamily: 'Inter', fontSize: '1.4rem', color: '#919199', margin: 0, fontStyle: 'italic' }}>info@durgaville.com</p>
              </Grid.Column>
            </Grid>
        ...
        <Grid.Row only="tablet">
          ...
          <Grid.Column width={7} verticalAlign="middle">
            ...
            <Grid centered style={{ marginTop: '50px' }}>
              ...
              <Grid.Column floated="left" width={8} style={{ padding: 0 }}>
                <p style={{ fontFamily: 'Inter', fontSize: '1.2rem', color: '#919199', margin: 0, fontStyle: 'italic' }}>info@durgaville.com</p>
              </Grid.Column>
            </Grid>
            ...
            <Grid.Row width={7} verticalAlign="middle">
              <Grid centered style={{ marginBottom: '50px' }}>
                <Grid.Row width={4} style={{ padding: 0 }}>
                  <p style={{ fontWeight: 'bold', fontFamily: 'Inter', fontSize: '1.1rem', color: '#606166', marginBottom: '2%' }}>ADDRESS</p>
                </Grid.Row>
                ...
                <Grid.Row width={4} style={{ padding: 0 }}>
                  <p style={{ fontWeight: 'bold', fontFamily: 'Inter', fontSize: '1.1rem', color: '#606166', marginBottom: '2%' }}>PHONE</p>
                </Grid.Row>
                ...
                <Grid.Row width={4} style={{ padding: 0 }}>
                  <p style={{ fontWeight: 'bold', fontFamily: 'Inter', fontSize: '1.1rem', color: '#606166', marginBottom: '2%' }}>EMAIL</p>
                </Grid.Row>
                ...
                <Grid.Row width={4} style={{ padding: 0 }}>
                  <p style={{ fontWeight: 'bold', fontFamily: 'Inter', fontSize: '1.1rem', color: '#606166', marginBottom: '2%' }}>SOCIAL</p>
                </Grid.Row>
