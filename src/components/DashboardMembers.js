                        ...
                        >
                           <Grid >
                                <Grid.Row style={{ borderBottom: '.7px solid #dee0e3', paddingBottom: '6%', marginRight:'14%' }}>
                                    <p onClick={()=> handlebuttonClick("home")} style={{fontWeight:'bolder', fontFamily: 'Inter',}}>HOME</p>                                    
                                </Grid.Row>

                                <Grid.Row style={{ borderBottom: '.7px solid #dee0e3', paddingBottom: '6%', marginRight:'14%' }}>
                                    <p onClick={()=> handlebuttonClick("upcoming-events")} style={{fontWeight:'bolder', fontFamily: 'Inter',}}>UPCOMING EVENTS</p>
                                </Grid.Row>

                                <Grid.Row style={{ borderBottom: '.7px solid #dee0e3', paddingBottom: '6%', marginRight:'14%' }}>
                                    <p onClick={()=> handlebuttonClick("meet-the-team")} style={{fontWeight:'bolder', fontFamily: 'Inter',}}>MEET THE TEAM</p>
                                </Grid.Row>

                                <Grid.Row style={{ borderBottom: '.7px solid #dee0e3', paddingBottom: '6%', marginRight:'14%' }}>
                                    <p onClick={()=> handlebuttonClick("admin-portal")} style={{fontWeight:'bolder', fontFamily: 'Inter',}}>ADMIN PORTAL</p>
                                </Grid.Row>
