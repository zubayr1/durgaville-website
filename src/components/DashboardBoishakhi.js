...
function DashboardBoishakhi() {
  ...
  return (
    <div style={{ overflow: "hidden" }}>
      <Helmet>
        <title>Boishakhi, 2025 - Durgaville</title>
        <meta
          name="description"
          content="Welcome to Durgaville, your go-to place for everything about Boishakhi, 2025 in Erlangen, Bavaria, Germany"
        />
      </Helmet>
      <Grid>
        <Grid.Row>
...
export default DashboardBoishakhi;
